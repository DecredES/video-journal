...
- Gobernanza: Este mes se presentaron {n} nuevas propuestas. Entre ellas la del equipo de América Latina y hace muy poquitos días terminó la votación que concluyó con la continuidad de dos proyectos y la financiación de un nuevo sitio web.
...
- El Exchange Descentralizado, el DEX, ya está en etapa de prueba. Cualquier puede participar descargando el software e intercambiando Bitcoin por Decred en las redes de prueba. Cada vez falta menos para que el DEX sea lanzado en la red principal. Si tienen alguna duda sobre cómo instalar el cliente del DEX, recuerden que pueden consultar en nuestro canal de Telegram: @DecredES
...
En mayo, Decred en Español organizó y participó en más de  eventos. Entre ellos:
...
5. Pablito dio un webinar sobre el Financiamiento de Software Open-Source, para que los devs encuentren formas de hacer que sus proyectos sean sustentables. Pueden encontrar el video completo acá, en nuestro canal.
