...
- Gobernanza: Este mes se presentaron 5 nuevas propuestas. Entre ellas, la del equipo de América Latina y hace muy poquitos días terminó la votación que concluyó con la continuidad de dos proyectos y la financiación de un nuevo sitio web.
...
El vspd es una **nueva implementación**, hecha desde cero, del **software para Proveedores de Servicio de Voto de Decred**. Este permite votar sin tener que dejar una computadora encendida las 24 horas. Si bien hace lo mismo, **el nuevo vspd cambia estructuralmente su sistema, brindando una mayor privacidad**.
...
El vspd también nos trae mejoras a los usuarios, ahora:
...
- El Exchange Descentralizado, el DEX, ya está en etapa de prueba. Cualquier puede participar descargando el software que se encuentra en la descripción de este video, e intercambiar Bitcoin por Decred en las redes de prueba. Cada vez falta menos para que el DEX sea lanzado en la red principal. Si tienen alguna duda sobre cómo instalar el cliente del DEX, recuerden que pueden consultar en nuestro canal de Telegram: @DecredES
...
Hoy tenemos una pequeña sección dedicada a los avances en investigación. Para quienes no lo sabían, entre los contratistas de Decred hay varios investigadores que dedican su tiempo a analizar datos y escribir sobre el estado de la blockchain de Decred, su gobernanza y intentando ver qué actividad on-chain tiene impacto en el precio.

- Checkmate publicó un artículo sobre el Realised Cap de Decred, un indicador muy similar al Market Cap que refleja la suma total de todas los créditos en circulación al precio actual, pero con una corrección muy importante: no se usa el precio actual que vemos en los exchanges para calcularlo, sino el precio de la última vez que se movio cada crédito en la blockchain. Si compre 10 DCR hace varios meses a 20 dólares y las moví a mi wallet, esas monedas le sumarán 200 dólares al Realised Cap, no importa si el precio actual es otro. Recién cuando las muevo, su precio se actualiza. Esta forma de medir el precio total de todo el DCR en el mercado permite sacar del medio mucho del ruido que los exchanges generan en el corto plazo y ver realmente qué están haciendo los holders. Ahí abajo en la descripción les dejamos el link al artículo.
...
5. Pablito dio un webinar sobre el Financiamiento de Software Open-Source, para que los devs encuentren formas de hacer que sus proyectos sean sustentables. (espacio para un poco del footage - preview) Pueden encontrar el video completo acá, en nuestro canal.
